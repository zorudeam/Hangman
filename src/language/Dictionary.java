 ...
 * objects of the {@link language.Word} class. See the
 ...
 * @see language.Word The type of object stored in this {@code Collection}.
...
/* Dictionary operations (non-static) */
    ...
    public Word randomWord() {
        Difficulty d = words.keySet().stream().findAny().get();
